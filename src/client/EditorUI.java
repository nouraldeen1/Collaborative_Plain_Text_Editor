...
public class EditorUI extends Application {
    ...
    private void joinSession(String code) {
        try {
            ...
            codeLabel.setText(isEditor ? "Editor Code: " + document.getEditorCode() + "\nViewer Code: " + document.getViewerCode() : "Viewer Mode");
        } catch (Exception e) {
            showError("Error joining session: " + e.getMessage());
        }
    }
    ...
    private void updateCursor(String data) {
        Platform.runLater(() -> {
